...
export default function OrdersPage() {
  ...
  const updateStatus = async (orderId: string, status: string) => {
    ...
    try {
      ...
      setOrders(prev =>
        prev.map(o => (o.id === orderId ? { ...o, status: result.status } : o))
      );
    } catch (err) {
                  ...
                  <div className="px-6 pb-5 border-t border-gray-100 pt-4">
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-100 flex items-center gap-3">
                      ...
                      <select
                        ...
                        className="px-3 py-1.5 border border-gray-200 rounded-lg text-sm bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500 disabled:opacity-50"
